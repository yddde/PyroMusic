...
async def ping(client, m: Message):
    ...
    await m_reply.edit(
        f"**✶ مرحباً بك عزيزي بوت الأغاني يعمل بنجاح .**\n[ㅤㅤㅤㅤㅤㅤ]({PING_PIC})\n**༄ 𝐏𝐢𝐧𝐠 ⇝** `{delta_ping * 1000:.3f}ms ` \n**༄ 𝐔𝐩𝐭𝐢𝐦𝐞 ⇝**  {uptime}\n\n  ༄  [𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 🎼](t.me/OnIySad)\n  ༄  [𝐒𝐨𝐮𝐫𝐜𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ⚜](t.me/JustForZaid)"
    )

@Client.on_message(
    filters.user(SUDO_USERS) & filters.command(["restart","zaid","ريستارت"], prefixes=f"{HNDLR}")
)
...
**༄ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 ↠** [𝐙 𝐀 𝐈 𝐃 🎼](t.me/OnIySad)\n**༄ 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ↠** [𝐒𝐨𝐮𝐫𝐜𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 ⚜‍](t.me/JustForZaid) .\n\n**༄ 𝐎𝐰𝐧𝐞𝐫 ↠ [{OWNER_NAME}](t.me/{OWNER}) **\n\n𐂂
